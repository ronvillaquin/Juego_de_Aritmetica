...
public class DatosSQLiteCombinados {
    ...
    public DatosSQLiteCombinados(Activity activity){
    ...
    public void RecuperaDatos(){
        ...
        fila = bd.rawQuery("select psn1,psn2,psn3,psn4,psn5,psn6,psn7,psn8,psn9,psn10 from pcombinado WHERE rowid="+1, null);
