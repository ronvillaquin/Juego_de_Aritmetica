...
public class MainActivity2_Premium extends AppCompatActivity implements PurchasesUpdatedListener {

    BillingClient billingClient;
    List<String> skuList = new ArrayList<>();

    String id=""; // lo llamo desde la clase flavor mejor para tener contrl de todo
...
//    String id = "android.test.purchased";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main_activity2_premium);
        ...
        if (b){  // if (b == true) -- (pero se simplifica)
...
//            Toast.makeText(this, getResources().getString(R.string.premiumBuscado), Toast.LENGTH_LONG).show();
            Snackbar.make(view, getResources().getString(R.string.premiumBuscado), Snackbar.LENGTH_SHORT).show();
...
//                            if (sourcePurchase != null) {
            ...
            public void onBillingServiceDisconnected() {
                ...
                Toast.makeText(MainActivity2_Premium.this, getResources().getString(R.string.conexion), Toast.LENGTH_SHORT).show();
...
//                                        tvPrice.setText("El precio es: " + price);
                                        String muestraPrice = getResources().getString(R.string.eliminarAnuncios) + " " + price;
                                        tvPrice.setText(muestraPrice);
                                        ...
                                        btnAdquirir.setOnClickListener(new View.OnClickListener() {
                                            ...
                                            public void onClick(View v) {
                                                BillingFlowParams flowParams = BillingFlowParams.newBuilder()
                                                        ...
                                                        .build();
                                                billingClient.launchBillingFlow(MainActivity2_Premium.this, flowParams);
                                            }
                                        });
...
//            Toast.makeText(this, getResources().getString(R.string.usuarioPremium), Toast.LENGTH_LONG).show();
            ...
            finish();
            Intent intent = new Intent(this, MainActivity2_Principal.class);
...
//            Toast.makeText(this, getResources().getString(R.string.desconectadodelpago), Toast.LENGTH_LONG).show();
            Snackbar.make(view, getResources().getString(R.string.desconectadodelpago), Snackbar.LENGTH_SHORT).show();
            // cancelo el pago
        }
    }
                ...
                AcknowledgePurchaseResponseListener acknowledgePurchaseResponseListener =
                        new AcknowledgePurchaseResponseListener() {
                            ...
                            public void onAcknowledgePurchaseResponse(BillingResult billingResult) {
                                setBoolInPref(MainActivity2_Premium.this, "myPref", id, true);
                            }
                        };
